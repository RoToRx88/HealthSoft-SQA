...
Combined to our existing process such as continuous integration on the unit test system, and the Test Dirven Development methodology we are using, we can ensure a very high level of quality. It also helps us a lot if we have to reorient the project in another direction the check for regression.
...
Also, the contract will have to be adapted to this new method. Indeed, changing to an Agile framework affect all the departments of the company. Now we are working __with__ the customer we will have to be covered in case of behaviour from him if something goes wrong.

It is a total new way to work for the customer, and as they are not used to work in that kind of continuous flux of information and solicitation it can be tough for them to work in those conditions and it can lead to major arguments.

After this formation passed for all the staff, and once the new invoice system introduced and the law department adapted our contracts, we will start to change all the rest. The idea is that every time a team finish a project, they will have the possibility to split (according to the manifesto for Agile software development says _“Build projects around motivated individuals. Give them the environment and support they need, and trust them to get the job done.”_), and create new teams for the incoming projects. This way, individuals are motivated to work on projects they want. They will have to keep in mind that a team must be multidisciplinary. They also will have to choose a Scrum Master, and a Product Owner.

## Measurement

As the manifesto for Agile software development says, “__Individuals and interactions__ over processes and tools, __Working software__ over comprehensive documentation”, we won’t introduce process to see the rentability of each employee and the goal of the measurement is not to control you and your productivity, but have a proper feedback of what is working or not, in order to improve continuously our way of working.

The most important measurement we will introduce is the feedback of the customer. At the end of each project, we will ask to the customer if he wants to do an interview with us and giving his feedback about our way of work together, what he thinks about it, what he would recommend doing or not, and if he would recommend us to another company. This interview is filmed and then posted on our YouTube channel, and relayed by our website. We consider that a project is a success if the customer is happy of our service, and therefore accept to do the interview.

In a matter of software quality, we still must use a few tools such as test units and non-regressions test to ensure that the software we are developing is on good tracks.

As we have a record of the overshoot time for each previous delivery, we will compare that with the future projects and deduce the efficiency of the new framework. We also must take in account the quality of the software produced, (indicated by the tools we have, unit test, non-regression tests, code audit, etc…) and correlate it with the satisfaction of the customer.

Finally, as most important metric, we will use one according to the manifesto for Agile software development _”Working software is the primary measure of progress.”_

## Conclusion

This adoption of the new framework will take time, but we hope that in the future, it will serve us as a company, but also as humans working together. The Agile Manifesto should be your bible for the next few months, and we encourage you to read it, integrate it, and most importantly discuss about it with your work mate. We are performing this change all together.
